...
class VinoRepository(private val todoDao: TodoDao,
    ...
    suspend fun getCurrentLocationAlerts(latitude: Double, longitude: Double): WeatherBasic {
        return vinoWeatherService.getCurrentLocationAlerts(latitude, longitude)
    }
}